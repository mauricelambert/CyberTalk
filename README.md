...
2. Cehck hash algorithm with beconfirm requests through a different communication channel (phone, instant message, etc.) and never respond to or use the contact information provided in the suspicious email.rtille credentials -> sha256
